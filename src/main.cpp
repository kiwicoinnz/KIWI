...
int64 nChainStartTime = 1422602680;
...
int64 GetProofOfWorkReward(int nHeight, int64 nFees, uint256 prevHash)
{
	...
	if(nHeight == 1)
	{
		nSubsidy = 2000000 * COIN;	// 200K coins Premine
		return nSubsidy + nFees;
	}
    if (nHeight <= 2880) {
         nSubsidy = 500 * COIN; // 500 Coins Per Block For 2 days
        return nSubsidy + nFees;   
    }
...
bool CBlock::ConnectBlock(CTxDB& txdb, CBlockIndex* pindex, bool fJustCheck)
{
    ...
    bool fEnforceBIP30 = true; // Always active in KiwiCoin
    bool fStrictPayToScriptHash = true; // Always active in KiwiCoin
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "KiwiCoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "January 30, 2015. Russel Norman resigns as Greens co-leader. 1422413025";
        CTransaction txNew;
        ...
        assert(block.hashMerkleRoot == uint256("1a1a4a391f2eb66cde578b4661792559d04b7e95b2e741ea3d059d431e601fe8"));
